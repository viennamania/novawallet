...
const contractAddress = "0xc2132D05D31c914a87C6611C10748AEb04B58e8F"; // NOVART on Polygon
const contractAddressArbitrum = "0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9"; // NOVART on Arbitrum
...
export default function Index({ params }: any) {
  ...
  const {
    ...
    useEffect(() => {
      ...
      setKrwAmount( Math.round(novartAmount * rate) );
                    ...
                    >
                      ...
                      <div className="flex flex-col xl:flex-row gap-5 xl:gap-10 items-center">
                        ...
                        <div className="flex flex-col gap-2 items-start">
                          ...
                          <p className="mt-4 text-xl font-bold text-zinc-400">1 NOVART = {
                            // currency format
                          ...
                          <div className=" flex flex-row items-center gap-2">
                            <p className="text-xl text-blue-500 font-bold ">
                              ...
                              />
                              <span className="ml-1 text-sm">NOVART</span>
                            </p>
                              ...
                              {krwAmount > 0 && (
                                <div className="text-lg font-semibold text-zinc-400">
                                  {Rate}: {
                                    ...
                                    // currency format
                                    Number((krwAmount / novartAmount).toFixed(2)).toLocaleString('ko-KR', {
                                      style: 'currency',
                                      currency: 'KRW'
                                    })
                        ...
                        <textarea
                          ...
                          placeholder="
                            ...
                            After the buyer accepts the order, you must deposit the NOVART to escrow within 1 hour.
                            If you do not deposit the NOVART to escrow within 1 hour, the order will be expired.
                        ...
                        */}
                        ...
                        <div className="mt-4 text-sm text-zinc-400">
                          ...
                          <div className="h-2 w-2 bg-zinc-400 rounded-full inline-block mr-2"></div>
                          <span>After the buyer accepts the order, you must deposit the NOVART to escrow within 1 hour.
                            If you do not deposit the NOVART to escrow within 1 hour, the order will be expired.
                          </span>
                        </div>
                        <div className="mt-4 text-sm text-zinc-400">
                            ...
                            <div className="mt-4 flex flex-col items-start gap-2">
                              ...
                              <div className="flex flex-row items-start gap-2">
                                ...
                                <p className="text-lg font-semibold text-white">{Rate}: {
                                  ...
                                  Number(item.krwAmount / item.novartAmount).toFixed(2)
